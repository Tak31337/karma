 ...
 */
public class AutoVoice extends Function {
    ...
    public void run() {
        ...
        if (message.startsWith("~autovoice")) {
           Main.bot.sendMessage(channel, "Auto voice toggled.");
           Main.autoVoice = Main.autoVoice?false:true;
        }
    }
}
